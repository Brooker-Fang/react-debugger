...
function propagateParentContextChanges(
  ...
  workInProgress.flagsStr = addFlags(workInProgress, workInProgress.flagsStr, 'DidPropagateContext');
}
  ...
  if (lastContextWithAllBitsObserved === context) {
    ...
    if (lastContextDependency === null) {
      ...
      if (enableLazyContextPropagation) {
        ...
        workInProgress.flagsStr = addFlags(workInProgress, workInProgress.flagsStr, 'NeedsPropagation');
      }
    } else {
